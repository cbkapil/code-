        ...
        {/* -------------------MainForm Part Start----------------- */}
            <View style = {styles.MainForm}>
                ...
                <View style= {styles.MainFormEntry}>
                    ...
                    <View style={styles.MainFormFirstEntery}>
                        <Text style = {styles.FirstEntText}>5. Exhaust profile cutting in Lav. side wall( LSCN/LGS)</Text>
                        ...
                        <View style = {styles.FirstEntObserve}>
                            ...
                            <View style = {styles.EntryObserveRadio}>
                                ...
                                <RadioButton
                                     value="OK"
                                     status={checked95 === 'OK' ? 'checked' : 'unchecked'}
                                     onPress={() => setChecked95('OK')}
                                />
                                <Text style={styles.FirstEntObserveRadio}>NOT OK</Text>
                                <RadioButton
                                     value="NOT OK"
                                     status={checked95 === 'NOT OK' ? 'checked' : 'unchecked'}
                                     onPress={() => setChecked95('NOT OK')}
                                />
                            </View>
                    ...
                    {/* Form Entry Five Section End */}
                      ...
                      <View style={styles.MainFormFirstEntery}>
                        <Text style = {styles.FirstEntText}>6. Wogo bkt for electrical(LSCN/LGS)   </Text>
                        ...
                        <View style = {styles.FirstEntObserve}>
                            ...
                            <View style = {styles.EntryObserveRadio}>
                                ...
                                <RadioButton
                                     value="Provided"
                                     status={checked96 === 'Provided' ? 'checked' : 'unchecked'}
                                     onPress={() => setChecked96('Provided')}
                                />
                                <Text style={styles.FirstEntObserveRadio}>Not Provided</Text>
                                <RadioButton
                                     value="Not Provided"
                                     status={checked96 === 'Not Provided' ? 'checked' : 'unchecked'}
                                     onPress={() => setChecked96('Not Provided')}
                                />
                            </View>
                    ...
                    <View style={styles.MainFormFirstEntery}>
                        <Text style = {styles.FirstEntText}>7. Dents in side wall </Text>
                    ...
                    <View style={styles.MainFormFirstEntery}>
                        <Text style = {styles.FirstEntText}>8. Condition of RWG </Text>
                    ...
                    <View style={styles.MainFormFirstEntery}>
                        <Text style = {styles.FirstEntText}>9. Side wall and Lav. side wall with member  spots welding</Text>
                    ...
                    <View style={styles.MainFormFirstEntery}>
                        <Text style = {styles.FirstEntText}>11. Conduit hole on  roof flange   </Text>
                    ...
                    <View style={styles.MainFormFirstEntery}>
                        <Text style = {styles.FirstEntText}>12. Car line joint welding and  leakage test</Text>
                    ...
                    <View style={styles.MainFormFirstEntery}>
                        <Text style = {styles.FirstEntText}>13. Power panel indictor hole at Lav. side wall(PP side)</Text>
                    ...
                    <View style={styles.MainFormFirstEntery}>
                        <Text style = {styles.FirstEntText}>14. Dog box, suggestion box and Louvre profile cut</Text>
                        ...
                        <View style = {styles.FirstEntObserve}>
                            ...
                            <View style = {styles.EntryObserveRadio}>
                                ...
                                <RadioButton
                                     value="Provided"
                                     status={checked104 === 'Provided' ? 'checked' : 'unchecked'}
                                     onPress={() => setChecked104('Provided')}
                                />
                                <Text style={styles.FirstEntObserveRadio}>Not Provided</Text>
                                <RadioButton
                                     value="Not Provided"
                                     status={checked104 === 'Not Provided' ? 'checked' : 'unchecked'}
                                     onPress={() => setChecked104('Not Provided')}
                                />
                            </View>
                    ...
                    <View style={styles.MainFormFirstEntery}>
                        <Text style = {styles.FirstEntText}>15. Window seal joint elevation and leakage test</Text>
                        ...
                        <View style = {styles.FirstEntObserve}>
                            ...
                            <View style = {styles.EntryObserveRadio}>
                                ...
                                <RadioButton
                                     value="OK"
                                     status={checked105 === 'OK' ? 'checked' : 'unchecked'}
                                     onPress={() => setChecked105('OK')}
                                />
                                <Text style={styles.FirstEntObserveRadio}>NOT OK</Text>
                                <RadioButton
                                     value="NOT OK"
                                     status={checked105 === 'NOT OK' ? 'checked' : 'unchecked'}
                                     onPress={() => setChecked105('NOT OK')}
                                />
                            </View>
                    ...
                    <View style={styles.MainFormFirstEntery}>
                        <Text style = {styles.FirstEntText}>16. Car line with side wall joint brazing </Text>
                    ...
                    <View style={styles.MainFormFirstEntery}>
                        <Text style = {styles.FirstEntText}>17. Side wall member  joint grinding work </Text>
