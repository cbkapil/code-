      ...
      {/* -------------------MainForm Part Start----------------- */}
            ...
            <View style = {styles.MainForm}>
                ...
                <View style= {styles.MainFormEntry}>
                    ...
                    <View style={styles.MainFormFirstEntery}>
                        <Text style = {styles.FirstEntText}>13. Dimension for AC Opening for RMPU (Lateral/longitudinal)</Text>
                    ...
                    <View style={styles.MainFormFirstEntery}>
                        <Text style = {styles.FirstEntText}>14. Lav. Mounting bracket distance</Text>
                    ...
                    <View style={styles.MainFormFirstEntery}>
                        <Text style={styles.FirstEntText}>
                        15. Carline and roof sheet welding both side         
                        </Text>
                        <View style={styles.FirstEntObserve}>
                        <Text style={styles.FirstEntObserveText1}>
                            Observed value/condition
                    ...
                    <View style={styles.MainFormFirstEntery}>
                        <Text style={styles.FirstEntText}>
                        16. Roof arch & carline sheet both side welding        
                        </Text>
                        <View style={styles.FirstEntObserve}>
                        <Text style={styles.FirstEntObserveText1}>
                            Observed value/condition
                    ...
                    <View style={styles.MainFormFirstEntery}>
                        <Text style={styles.FirstEntText}>
                        17. Both side Sidewall vertical pillar & U/F covering plate welding         
                        </Text>
                        <View style={styles.FirstEntObserve}>
                        <Text style={styles.FirstEntObserveText1}>
                            Observed value/condition
                    ...
                    <View style={styles.MainFormFirstEntery}>
                        <Text style={styles.FirstEntText}>
                        18. Door cut out welding bottom side with Under frame door profile         
                        </Text>
                        <View style={styles.FirstEntObserve}>
                        <Text style={styles.FirstEntObserveText1}>
                            Observed value/condition
                    ...
                    <View style={styles.MainFormFirstEntery}>
                        <Text style={styles.FirstEntText}>
                        19. Roof element & Lav. Sidewall welding inside & out side         
                        </Text>
                        <View style={styles.FirstEntObserve}>
                        <Text style={styles.FirstEntObserveText1}>
                            Observed value/condition
                    ...
                    <View style={styles.MainFormFirstEntery}>
                        <Text style={styles.FirstEntText}>
                        20. Lav. sidewall & sidewall both side welding with door cut out        
                        </Text>
                        <View style={styles.FirstEntObserve}>
                        <Text style={styles.FirstEntObserveText1}>
                            Observed value/condition
                    ...
                    <View style={styles.MainFormFirstEntery}>
                        <Text style={styles.FirstEntText}>
                        21. Both side end wall with Lav. Sidewall, roof element &U/F front part welding         
                        </Text>
                        <View style={styles.FirstEntObserve}>
                        <Text style={styles.FirstEntObserveText1}>
                            Observed value/condition
                    ...
                    {/* Form Entry twenty two Section End */}
                     ...
                     <View style={styles.MainFormFirstEntery}>
                    <Text style = {styles.FirstEntText}>23. Cross brace height (LBAC)</Text>
                        <View style={styles.FiveEntryPart}>
                            <Text style = {styles.FirstEntText}>23a. With cannel</Text>
                        ...
                        <View style={styles.FiveEntryPart}>
                            <Text style = {styles.FirstEntText}>23b. Without cannel</Text>
                            <View style = {styles.FirstEntObserve}>
                                <Text style = {styles.FirstEntObserveText1}>Observed value/condition</Text>
                                <TextInput style= {styles.FirstEntRemarkInput}
                                    onChange = {setObservedValues37}
                                    value = {observedValues37}
                                />
                    ...
                    <View style={styles.MainFormFirstEntery}>
                        <Text style={styles.FirstEntText}>
                        24. Complete shell assembly outside & inside grinding work        
                        </Text>
                        <View style={styles.FirstEntObserve}>
                        <Text style={styles.FirstEntObserveText1}>
                            Observed value/condition
                    ...
                    <View style={styles.MainFormFirstEntery}>
                        <Text style = {styles.FirstEntText}>25. Roof element RMPU socket hole die and alignment with end wall </Text>
                        <View style = {styles.FirstEntObserve}>
                            <Text style = {styles.FirstEntObserveText1}>Observed value/condition</Text>
                            <View style = {styles.EntryObserveRadio}>
                                <Text style={styles.FirstEntObserveRadio}>OK</Text>
                    ...
                    <View style={styles.MainFormFirstEntery}>
                        <Text style = {styles.FirstEntText}>26. Body width(inside)</Text>
                    ...
                    <View style={styles.MainFormFirstEntery}>
                        <Text style = {styles.FirstEntText}>27. Roof height from trough sheet to roof sheet </Text>
                    ...
                    <View style={styles.MainFormFirstEntery}>
                        <Text style = {styles.FirstEntText}>28. D.B(1230 mm) &C.N bkt</Text>
                    ...
                    <View style={styles.MainFormFirstEntery}>
                        <Text style = {styles.FirstEntText}>29. Insulating pins</Text>
                        ...
                        <View style = {styles.FirstEntObserve}>
                            ...
                            <View style = {styles.EntryObserveRadio}>
                                ...
                                <RadioButton
                                     value="Provided"
                                     status={checked71 === 'Provided' ? 'checked' : 'unchecked'}
                                     onPress={() => setChecked71('Provided')}
                                />
                                <Text style={styles.FirstEntObserveRadio}>Not Provided</Text>
                                <RadioButton
                                     value="Not Provided"
                                     status={checked71 === 'Not Provided' ? 'checked' : 'unchecked'}
                                     onPress={() => setChecked71('Not Provided')}
                                />
                            </View>
