import {
  ...
  const QMF_2011_D_ROOF = ({navigation}) => {
        ...
        <View style={styles.header}>
          ...
          <View style={styles.MainForm}>
            ...
            <View style={styles.MainFormTag}>
              <Text style={styles.MainFormTagText}>E-SHELL:</Text>
            </View>
            {/* Form Title End*/}
            ...
            <View style={styles.MainFormEntry}>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  1. Alignment of roof  center line, side wall center line & U/F center line (LGS,LSCN)
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  6. Welding &grinding of side wall with sole bar               
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  7. Partition frame welding & alignment conduction(LSCN,LGS) 
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  8. Lav. Mounting bracket distance (LGS without PRT)
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  9. Carline and roof sheet welding both side            
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  10. Roof arch & carline sheet both side welding          
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  11. Both side Sidewall vertical pillar & U/F covering plate welding          
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  12. Door cut out welding bottom side with Under frame door profile 
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  13. WTCC & Lav. Sidewall welding inside & out side
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  14. Lav. sidewall & sidewall both side welding with door cut out
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  15. Both side end wall with Lav. Sidewall, roof element &U/F front part welding
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  16. Complete shell assembly outside & inside grinding work
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                ...
                <View style={styles.FirstEntObserve}>
                  ...
                  <View style={styles.EntryObserveRadio}>
                    ...
                    <RadioButton
                      value="Provided"
                      status={checkedk145 === 'Provided' ? 'checked' : 'unchecked'}
                      onPress={() => setCheckedk145('Provided')}
                    />
                    <Text style={styles.FirstEntObserveRadio}>Not Provided</Text>
                    <RadioButton
                      value="Not Provided"
                      status={checkedk145 === 'Not Provided' ? 'checked' : 'unchecked'}
                      onPress={() => setCheckedk145('Not Provided')}
                    />
                  </View>
                </View>
                <View style={styles.FirstEntRemark}>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  19. Expended metal welding with partition frame(LSCN/LGS)
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  20. Chair angle & J molding (LSCN/LGS) 
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  21. Partition frame with sidewall back piece welding(LSCN/LGS)
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  22. Partition frame welding in lav. Area (LSCN/LGS)
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>23. Hole alignment part pillar to transverse side partition pillar(LSCN)</Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>24 Both side lav. Z member (LSCN/LGS)</Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>25. All door above wago bracket and conduit bracket(LSCN/LGS)  </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  26. 30L auxiliary Water tank bracket welding (LSCN)
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  27 Chair angle height from lower flange (LGS/LSCN)
                </Text>
  
                
                <View style={styles.FirstEntRemark}>
                  <Text style={styles.FirstEntRemarkText1}>Observed value/condition</Text>
                  <TextInput
                    style={styles.FirstEntRemarkInput}
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  28 Part pillar height (lower  hole centre) from under frame lower flange (upper/lower) for LSCN
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  29 Cabin inner width longitudinal side & transverse side(LGS) 
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  30 Upper berth height in longitudinal side cabin for LSCN
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  31 Lav. Partition frame distance from end wall for LSCN/LGS & gang way area gap
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  32. Distance from side wall pillar to partition pillar transverse side/longitudinal side for LSCN/LGS
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  33. Distance from side wall pillar to partition pillar transverse side/longitudinal side for LGS
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  34. Corridor area after partition frame(LSCN) 
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  35. Roof height from trough sheet to roof sheet (LSCN,LGS)
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  36. Height from roof pillar mounting bkt to trough sheet pillar mounting channel.
                </Text>
              ...
              <View style={styles.MainFormFirstEntery}>
              <Text style={styles.FirstEntText}>
                  37. Distance between pull box bkt from center line of side wall(LSCN)
                </Text>
            ...
            <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>
                  38. Distance between middle door center and pull box
Bkt center in transverse side(LH/RH)LGS
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>39. D.B(1230 mm) &C.N bkt </Text>
  ...
  export default QMF_2011_D_ROOF;
