      ...
      <View style={styles.Maincontainer}>
        ...
        <View style={styles.MainForm}>
          ...
          <View style={styles.MainFormEntry}>
            ...
            <View style={styles.MainFormFirstEntery}>
              ...
              <View style={styles.FirstEntObserve}>
                ...
                <View style={styles.EntryObserveRadio}>
                  ...
                  <RadioButton
                    value="OK"
                    status={checkedk5 === 'OK' ? 'checked' : 'unchecked'}
                    onPress={() => setCheckedk5('OK')}
                  />
                  <Text style={styles.FirstEntObserveRadio}>NOT OK</Text>
                  <RadioButton
                    value="NOT OK"
                    status={checkedk5 === 'NOT OK' ? 'checked' : 'unchecked'}
                    onPress={() => setCheckedk5('NOT OK')}
                  />
                </View>
              </View>
              <View style={styles.FirstEntRemark}>
                ...
                <TextInput
                  style={styles.FirstEntRemarkInput}
                  onChangeText={remarkk11 => {
                    setremarkk11(remarkk11);
                  }}
                />
              </View>
            </View>
            ...
            <View style={styles.MainFormFirstEntery}>
              <Text style={styles.FirstEntText}>
                9. DG mounting bkt distance
              </Text>
              <View style={styles.FiveEntryPart}>
                <Text style={styles.FirstEntText}>Lateral</Text>
              ...
              <View style={styles.FiveEntryPart}>
                <Text style={styles.FirstEntText}>Longitudinal (LH)</Text>
              ...
              <View style={styles.FiveEntryPart}>
                <Text style={styles.FirstEntText}>Longitudinal (RH)</Text>
            ...
            <View style={styles.MainFormFirstEntery}>
              <Text style={styles.FirstEntText}>
                10. Machine bkt mounting distance (Outer to Outer)
              </Text>

              <View style={styles.FiveEntryPart}>
                <Text style={styles.FirstEntText}>M/C-I</Text>
                <View style={styles.SubObserve}>
                  <Text style={styles.SubObserveText}>
                    Observed value/condition
                  </Text>
              ...
              <View style={styles.FiveEntryPart}>
                <Text style={styles.FirstEntText}>M/C-II</Text>
            ...
            <View style={styles.MainFormFirstEntery}>
              <Text style={styles.FirstEntText}>
                11. Distance between bio tank brackets Holes. (Longitudinal x
                Lateral)
              </Text>
            ...
            <View style={styles.MainFormFirstEntery}>
              <Text style={styles.FirstEntText}>12. Shunting bracket.</Text>
            ...
            <View style={styles.MainFormFirstEntery}>
              <Text style={styles.FirstEntText}>13. Lifting pad.</Text>
            ...
            <View style={styles.MainFormFirstEntery}>
              ...
              <View style={styles.FirstEntObserve}>
                ...
                <View style={styles.EntryObserveRadio}>
                  ...
                  <Text style={styles.FirstEntObserveRadio}>50MM</Text>
                  <RadioButton
                    value="50MM"
                    status={checkedk6 === '50MM' ? 'checked' : 'unchecked'}
                    onPress={() => setCheckedk6('50MM')}
                  />
                </View>
              </View>
              <View style={styles.FirstEntRemark}>
            ...
            <View style={styles.MainFormFirstEntery}>
              <Text style={styles.FirstEntText}>
                15. Both sides covering plate welding.
              </Text>
            ...
            <View style={styles.MainFormFirstEntery}>
              <Text style={styles.FirstEntText}>
                17. Supporting member on trough sheet welding.
              </Text>
            ...
            <View style={styles.MainFormFirstEntery}>
              <Text style={styles.FirstEntText}>
                18. Battery box bracket hole (18 Ø) distance from hole center to
            ...
            <View style={styles.MainFormFirstEntery}>
              <Text style={styles.FirstEntText}>
                19. Transformer bracket hole (18 Ø,8 nos. ) distance from hole
            ...
            <View style={styles.MainFormFirstEntery}>
              <Text style={styles.FirstEntText}>
                20. Air brake module hole (12 Ø) distance from hole center to
            ...
            <View style={styles.MainFormFirstEntery}>
              <Text style={styles.FirstEntText}>
                21. Feeder junction hole(11 Ø) on head stock{' '}
              </Text>
            ...
            <View style={styles.MainFormFirstEntery}>
              <Text style={styles.FirstEntText}>
                24. Both side front part area wash washing drain hole{' '}
              </Text>
            ...
            <View style={styles.MainFormFirstEntery}>
              <Text style={styles.FirstEntText}>
                26. Door corner joint welding and grinding{' '}
              </Text>
            ...
            <View style={styles.MainFormFirstEntery}>
              <Text style={styles.FirstEntText}>
                28.Switch box bracket hole (14 Ø,8 nos.).
              </Text>
            ...
            <View style={styles.MainFormFirstEntery}>
              <Text style={styles.FirstEntText}>
                29 .Distance between both tank mounting hole and hole between
                distance
              </Text>
            ...
            <View style={styles.MainFormFirstEntery}>
              <Text style={styles.FirstEntText}>
                32 . Fuel tank mounting bkt distance(outer to outer)
              </Text>
