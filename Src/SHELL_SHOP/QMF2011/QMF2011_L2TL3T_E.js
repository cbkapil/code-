        ...
        <View style={styles.header}>
          ...
          <View style={styles.MainForm}>
            ...
            <View style={styles.MainFormEntry}>
              ...
              <View style={styles.MainFormFirstEntery}>
                <Text style={styles.FirstEntText}>27. Roof height from trough sheet to roof sheet (L3T,L2T)</Text>
                ...
                <View style={styles.FirstEntObserve}>
                  ...
                  <TextInput
                    style={styles.FirstEntRemarkInput}
                    onChangeText={observedvaluek75 => {
                      setobservedvaluek75(observedvaluek75);
                    }}
                  />
                </View>
                <View style={styles.FirstEntRemark}>
