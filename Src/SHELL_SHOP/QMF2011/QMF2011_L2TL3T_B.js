      ...
      <View style={styles.header}>
        ...
        <View style={styles.MainForm}>
          ...
          <View style={styles.MainFormEntry}>
            ...
            <View style={styles.MainFormFirstEntery}>
              ...
              <View style={styles.FirstEntObserve}>
                ...
                <View style={styles.EntryObserveRadio}>
                  ...
                  <RadioButton
                    value="OK"
                    status={checkedk104 === 'OK' ? 'checked' : 'unchecked'}
                    onPress={() => setCheckedk104('OK')}
                  />
                  <Text style={styles.FirstEntObserveRadio}>NOT OK</Text>
                  <RadioButton
                    value="third"
                    status={checkedk104 === 'NOT OK' ? 'checked' : 'unchecked'}
                    onPress={() => setCheckedk104('NOT OK')}
                  />
                </View>
              </View>
              <View style={styles.FirstEntRemark}>
                ...
                <TextInput
                  style={styles.FirstEntRemarkInput}
                  onChangeText={remarkk157 => {
                    setremarkk157(remarkk157);
                  }}
                />
              </View>
            </View>
            ...
            <View style={styles.MainFormFirstEntery}>
              ...
              <View style={styles.FiveEntryPart}>
                ...
                <View style={styles.FirstEntRemark}>
                  ...
                  <TextInput
                    style={styles.FirstEntRemarkInput}
                    onChangeText={remarkk163 => {
                      setremarkk163(remarkk163);
                    }}
                  />
                </View>
              </View>
              <View style={styles.FiveEntryPart}>
                ...
                <View style={styles.SubObserveRemark}>
                  ...
                  <TextInput
                    style={styles.FirstEntRemarkInput}
                    onChangeText={remarkk164 => {
                      setremarkk164(remarkk164);
                    }}
                  />
                </View>
              </View>
            ...
            <View style={styles.MainFormFirstEntery}>
              <Text style={styles.FirstEntText}>
                13. Pull box distance from center line
              </Text>
              <View style={styles.FiveEntryPart}>
                <Text style={styles.FirstEntText}>L2T</Text>
                <View style={styles.FiveEntryPart}>
                  <Text style={styles.FirstEntText}>Cabin Side</Text>
                  <View style={styles.FiveEntryPart}>
                    <View style={styles.FirstEntObserve}>
                      <Text style={styles.FirstEntObserveText1}>
                        Observed value/condition
                      ...
                      <TextInput
                        style={styles.FirstEntRemarkInput}
                        onChangeText={observedvaluek63 => {
                          setobservedvaluek63(observedvaluek63);
                        }}
                      />
                    </View>
                    <View style={styles.FirstEntRemark}>
                      ...
                      <TextInput
                        style={styles.FirstEntRemarkInput}
                        onChangeText={remarkk165=> {
                          setremarkk165(remarkk165);
                        }}
                      />
                    </View>
                  </View>

                  <Text style={styles.FirstEntText}>Single Side</Text>
                  <View style={styles.FiveEntryPart}>
                    <View style={styles.FirstEntObserve}>
                      <Text style={styles.FirstEntObserveText1}>
                        Observed value/condition
                      ...
                      <TextInput
                        style={styles.FirstEntRemarkInput}
                        onChangeText={observedvaluek64 => {
                          setobservedvaluek64(observedvaluek64);
                        }}
                      />
                    </View>
                    <View style={styles.FirstEntRemark}>
                      ...
                      <TextInput
                        style={styles.FirstEntRemarkInput}
                        onChangeText={remarkk166 => {
                          setremarkk166(remarkk166);
                        }}
                      />
                    </View>
                  </View>
              ...
              <View style={styles.FiveEntryPart}>
                ...
                <View style={styles.FiveEntryPart}>
                  <View style={styles.FirstEntObserve}>
                    ...
                    <TextInput
                      style={styles.FirstEntRemarkInput}
                      onChangeText={observedvaluek65 => {
                        setobservedvaluek65(observedvaluek65);
                      }}
                    />
                  </View>
                  <View style={styles.FirstEntRemark}>
                    ...
                    <TextInput
                      style={styles.FirstEntRemarkInput}
                      onChangeText={remarkk167 => {
                        setremarkk167(remarkk167);
                      }}
                    />
                  </View>
                </View>
                ...
                <View style={styles.FiveEntryPart}>
                  <View style={styles.FirstEntObserve}>
                    ...
                    <TextInput
                      style={styles.FirstEntRemarkInput}
                      onChangeText={observedvaluek66 => {
                        setobservedvaluek66(observedvaluek66);
                      }}
                    />
                  </View>
                  <View style={styles.FirstEntRemark}>
                    ...
                    <TextInput
                      style={styles.FirstEntRemarkInput}
                      onChangeText={remarkk168 => {
                        setremarkk168(remarkk168);
                      }}
                    />
                  </View>
                </View>
            ...
            <View style={styles.MainFormFirstEntery}>
              ...
              <View style={styles.FirstEntObserve}>
                ...
                <RadioButton
                  value="Provided"
                  status={checkedk110 === 'Provided' ? 'checked' : 'unchecked'}
                  onPress={() => setCheckedk110('Provided')}
                />
                <Text style={styles.FirstEntObserveRadio}>Not Provided</Text>
                <RadioButton
                  value="Not Provided"
                  status={
                    checkedk110 === 'Not Provided' ? 'checked' : 'unchecked'
                  }
                  onPress={() => setCheckedk110('NOT Provided')}
                />
              </View>
              <View style={styles.FirstEntRemark}>
                <Text style={styles.FirstEntRemarkText1}>REMARKS</Text>
                <TextInput
                  style={styles.FirstEntRemarkInput}
                  onChangeText={remarkk169 => {
                    setremarkk169(remarkk169);
                  }}
                />
              </View>
            </View>
            ...
            <View style={styles.MainFormFirstEntery}>
              ...
              <View style={styles.FirstEntObserve}>
                ...
                <View style={styles.EntryObserveRadio}>
                  ...
                  <RadioButton
                    value="OK"
                    status={checkedk111 === 'OK' ? 'checked' : 'unchecked'}
                    onPress={() => setCheckedk111('OK')}
                  />
                  <Text style={styles.FirstEntObserveRadio}>NOT OK</Text>
                  <RadioButton
                    value="NOT OK"
                    status={checkedk111 === 'NOT OK' ? 'checked' : 'unchecked'}
                    onPress={() => setCheckedk111('NOT OK')}
                  />
                </View>
              </View>
              <View style={styles.FirstEntRemark}>
            ...
            <View style={styles.MainFormFirstEntery}>
              <Text style={styles.FirstEntText}>
                16. Car line with side wall joint brazing
              </Text>
            ...
            <View style={styles.MainFormFirstEntery}>
              ...
              <View style={styles.FirstEntObserve}>
                ...
                <RadioButton
                  value="Provided"
                  status={checkedk113 === 'Provided' ? 'checked' : 'unchecked'}
                  onPress={() => setCheckedk113('Provided')}
                />
                <Text style={styles.FirstEntObserveRadio}>Not Provided</Text>
                <RadioButton
                  value="Not Provided"
                  status={
                    checkedk113 === 'Not Provided' ? 'checked' : 'unchecked'
                  }
                  onPress={() => setCheckedk113('NOT Provided')}
                />
              </View>
              <View style={styles.FirstEntRemark}>
                <Text style={styles.FirstEntRemarkText1}>REMARKS</Text>
                <TextInput
                  style={styles.FirstEntRemarkInput}
                  onChangeText={remarkk172 => {
                    setremarkk172(remarkk172);
                  }}
                />
              </View>
            </View>
